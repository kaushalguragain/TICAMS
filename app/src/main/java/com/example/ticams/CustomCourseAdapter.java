...
public class CustomCourseAdapter extends RecyclerView.Adapter<CustomCourseAdapter.CourseListHolder>{
    ...
    public void onBindViewHolder(CourseListHolder holder, int position) {
        ...
        holder.courseName.setText((coursesDtos.get(position).getName()));
        holder.courseDescription.setText((coursesDtos.get(position).getDescription()));
        holder.courseAffilation.setText((coursesDtos.get(position).getAffilation()));
